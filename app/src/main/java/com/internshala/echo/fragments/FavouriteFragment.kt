...
/*Adding the fetched songs to the arraylist*/
                arrayList.add(Songs(currentId,currentDate,currentTitle,currentArtist,currentData))
            }
        } else {
            return null
        }
...
to the song title in our bottom bar*/
            songTitle?.setText(PlayingSongsFragment.Statified.currentSongHelper?.songTitle)
...
fragment using Bundle*/
            args.putString("songArtist",
                PlayingSongsFragment.Statified.currentSongHelper?.songArtist)
            args.putString("songTitle",
                PlayingSongsFragment.Statified.currentSongHelper?.songTitle)
            args.putString("path",
                PlayingSongsFragment.Statified.currentSongHelper?.songPath)
            args.putInt("songId",
                PlayingSongsFragment.Statified.currentSongHelper?.songId?.toInt() as Int)
            args.putInt("songPosition",
                PlayingSongsFragment.Statified.currentSongHelper?.currentPosition?.toInt() as Int)
            args.putParcelableArrayList("songData",
                PlayingSongsFragment.Statified.fetchSongs)
...
* and then change the button to play button*/
                ...
                trackPosition = PlayingSongsFragment.Statified.mediaPlayer?.currentPosition
                        as Int
